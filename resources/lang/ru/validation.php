...
return [
    ...
    */
    ...
    'required_if'          => ':attribute поле, обязательное для заполнения пока :other есть :value.',
    'required_unless'      => ':attribute field is required unless :other есть in :values.',
    'required_with'        => ':attribute поле, обязательное для заполнения пока :values есть present.',
    'required_with_all'    => ':attribute поле, обязательное для заполнения пока :values есть present.',
    'required_without'     => ':attribute поле, обязательное для заполнения пока :values is not present.',
