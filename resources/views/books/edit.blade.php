            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('update_book', $book->id) }}" method="post">
                    ...
                    <div class="form-group required">
                        ...
                        <input id="id-title" name="title" type="text" value="<?=$book->title?>" class="form-control" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group required">
                                ...
                                <input id="id-count_page" name="count_page" type="text" value="<?=$book->count_page?>" class="form-control" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group required">
                                ...
                                <select name="author_id" class="form-control" id="id-author_id" style="float:left; margin-right:20px;">
                                    ...
                                    <option value="<?=$author->id?>" {{ $book->author_id == $author->id ? 'selected="selected"' : '' }} ><?=$author->firstname?> <?=$author->lastname?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div style="clear:both;"></div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="annotation" rows="5" type="text" class="form-control" id="id-annotation" placeholder=""><?=$book->annotation?></textarea>
